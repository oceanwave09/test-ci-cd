...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="ecw_hospitalization_stage_to_fhirbundle_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "ecw_hospitalization"),
        )
        ...
        data_df = (
            ...
            .withColumn("encounter_date", parse_date_udf(f.col("hospitalization_date")))
