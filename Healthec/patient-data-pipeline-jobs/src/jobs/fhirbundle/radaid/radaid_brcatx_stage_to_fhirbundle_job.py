...
def _transform_procedure(row_dict: dict, transformer: FHIRTransformer) -> Row:
        ...
        data_dict["codes"].append(
            {
                ...
                "code_system": BRCA_TREATMENT_CODE_SYSTEM,
            }
        )
    ...
    data_dict["outcome_code"] = row_dict.get("tnm", "")
    data_dict["outcome_display"] = TNM_STAGE_DICT.get(row_dict.get("tnm", ""), "")
...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="radaid_brcatx_stage_to_fhirbundle_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "radaid_brcatx"),
        )
