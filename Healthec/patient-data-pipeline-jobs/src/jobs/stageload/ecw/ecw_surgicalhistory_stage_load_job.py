...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="ecw_surgicalhistory_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get("DELTA_TABLE_NAME", config.get("delta_table_name", "ecw_surgicalhistory"))
        ...
        # add additional columns and prepare dataframe which match with ecw surgicalhistory delta lake table structure
        surgicalhistory_df = (
            ...
            .withColumn("surgical_date", get_column(canonical_df, "surgical_date"))
        ...
        # write data into delta lake `ecw_surgicalhistory` table
        surgicalhistory_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "ecw_surgicalhistory", opsgenie_api_key, file_details)
