...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="ecw_vital_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get("DELTA_TABLE_NAME", config.get("delta_table_name", "ecw_vital"))
        ...
        # add additional columns and prepare dataframe which match with ecw vital delta lake table structure
        vital_df = (
            ...
            .withColumn("vitals_captured_by", get_column(canonical_df, "vitals_captured_by"))
            .withColumn("vitals_name", get_column(canonical_df, "vitals_name"))
            .withColumn("standard_vital", get_column(canonical_df, "standard_vital"))
            .withColumn("vitals_value", get_column(canonical_df, "vitals_value"))
        ...
        # write data into delta lake `ecw_vital` table
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "ecw_vital", opsgenie_api_key, file_details)
