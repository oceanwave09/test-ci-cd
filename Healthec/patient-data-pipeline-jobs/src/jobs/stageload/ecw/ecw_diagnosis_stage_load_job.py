...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="ecw_diagnosis_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get("DELTA_TABLE_NAME", config.get("delta_table_name", "ecw_diagnosis"))
        ...
        # add additional columns and prepare dataframe which match with ecw diagnosis delta lake table structure
        diagnosis_df = (
            ...
            .withColumn("assessment_onset_date", get_column(canonical_df, "assessment_onset_date"))
        ...
        diagnosis_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "ecw_diagnosis", opsgenie_api_key, file_details)
