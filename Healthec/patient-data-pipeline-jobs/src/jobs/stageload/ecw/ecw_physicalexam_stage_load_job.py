...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="ecw_physicalexam_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get("DELTA_TABLE_NAME", config.get("delta_table_name", "ecw_physicalexam"))
        ...
        # add additional columns and prepare dataframe which match with ecw physicalexam delta lake table structure
        physicalexam_df = (
        ...
        # write data into delta lake `ecw_physicalexam` table
        physicalexam_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "ecw_physicalexam", opsgenie_api_key, file_details)
