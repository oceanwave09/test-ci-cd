...
from utils.transformation import parse_date
...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="cclf_bene_alr1_7_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "cclf_bene_alr1_7"),
        )
        ...
        # add additional columns and prepare dataframe which match with cclf_bene_alr1_7 delta lake table structure
        alr1_7_df = (
            data_df.withColumn("row_id", get_column(data_df, "row_id"))
            .withColumn("bene_mbi_id", get_column(data_df, "bene_mbi_id"))
            .withColumn("b9729", get_column(data_df, "b9729"))
            .withColumn("u071", get_column(data_df, "u071"))
            .withColumn("covid19_episode", get_column(data_df, "covid19_episode"))
            .withColumn("admission_dt", f.to_date(parse_date_udf(get_column(data_df, "admission_dt"))))
            .withColumn("discharge_dt", f.to_date(parse_date_udf(get_column(data_df, "discharge_dt"))))
            .withColumn("covid19_month01", get_column(data_df, "covid19_month01"))
            .withColumn("covid19_month02", get_column(data_df, "covid19_month02"))
            .withColumn("covid19_month03", get_column(data_df, "covid19_month03"))
            .withColumn("covid19_month04", get_column(data_df, "covid19_month04"))
            .withColumn("covid19_month05", get_column(data_df, "covid19_month05"))
            .withColumn("covid19_month06", get_column(data_df, "covid19_month06"))
            .withColumn("covid19_month07", get_column(data_df, "covid19_month07"))
            .withColumn("covid19_month08", get_column(data_df, "covid19_month08"))
            .withColumn("covid19_month09", get_column(data_df, "covid19_month09"))
            .withColumn("covid19_month10", get_column(data_df, "covid19_month10"))
            .withColumn("covid19_month11", get_column(data_df, "covid19_month11"))
            .withColumn("covid19_month12", get_column(data_df, "covid19_month12"))
        ...
        # write data into delta lake `cclf_bene_alr1_7` table
        alr1_7_df.write.format("delta").mode("append").save(delta_table_location)
