...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "cclf7"),
        )
        ...
        # add additional columns and prepare dataframe which match with cclf7 delta lake table structure
        cclf7_df = (
            ...
            .withColumn("clm_line_ndc_cd", get_column(data_df, "clm_line_ndc_ cd"))
            ...
            .withColumn("prvdr_srvc_id_qlfyr_cd", get_column(data_df, "prvdr_srvc_id_qlfyr_cd"))
            .withColumn("clm_srvc_prvdr_gnrc_id_num", get_column(data_df, "clm_srvc_prvdr_gnrc_id_num"))
            .withColumn("clm_dspnsng_stus_cd", get_column(data_df, "clm_dspnsng_stus_cd"))
            .withColumn("clm_daw_prod_slctn_cd", get_column(data_df, "clm_daw_prod_slctn_cd"))
            .withColumn("clm_line_srvc_unit_qty", to_float_udf(get_column(data_df, "clm_line_srvc_unit_qty")))
            .withColumn("clm_line_days_suply_qty", to_int_udf(get_column(data_df, "clm_line_days_suply_qty")))
            .withColumn("prvdr_prsbng_id_qlfyr_cd", get_column(data_df, "prvdr_prsbng_id_qlfyr_cd"))
            .withColumn("clm_prsbng_prvdr_gnrc_id_num", get_column(data_df, "clm_prsbng_prvdr_gnrc_id_num"))
            .withColumn("clm_line_bene_pmt_amt", to_float_udf(get_column(data_df, "clm_line_bene_pmt_amt")))
            ...
            .withColumn("clm_line_rx_srvc_rfrnc_num", to_int_udf(get_column(data_df, "clm_line_rx_srvc_rfrnc_num")))
            .withColumn("clm_line_rx_fill_num", get_column(data_df, "clm_line_rx_fill_num"))
            .withColumn("clm_phrmcy_srvc_type_cd", get_column(data_df, "clm_phrmcy_srvc_type_cd"))
        ...
        # write data into delta lake `cclf7` table
        cclf7_df.write.format("delta").mode("append").save(delta_table_location)
