...
from utils.transformation import to_float, to_int
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "cclfb"),
        )
        ...
        # add additional columns and prepare dataframe which match with cclfb delta lake table structure
        cclfb_df = (
            ...
            .withColumn("clm_line_ngaco_pbpmt_sw", get_column(data_df, "clm_line_ngaco_pbpmt_sw"))
            .withColumn("clm_line_ngaco_pdschrg_hcbs_sw", get_column(data_df, "clm_line_ngaco_pdschrg_hcbs_sw"))
            .withColumn("clm_line_ngaco_snf_wvr_sw", get_column(data_df, "clm_line_ngaco_snf_wvr_sw"))
            .withColumn("clm_line_ngaco_tlhlth_sw", get_column(data_df, "clm_line_ngaco_tlhlth_sw"))
            .withColumn("clm_line_ngaco_cptatn_sw", get_column(data_df, "clm_line_ngaco_cptatn_sw"))
            ...
            .withColumn("clm_line_carr_hpsa_scrcty_cd", get_column(data_df, "clm_line_carr_hpsa_scrcty_cd"))
        ...
        # write data into delta lake `cclfb` table
        cclfb_df.write.format("delta").mode("append").save(delta_table_location)
