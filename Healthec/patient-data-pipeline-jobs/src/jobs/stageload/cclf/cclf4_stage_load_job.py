...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "cclf4"),
        )
        ...
        # add additional columns and prepare dataframe which match with cclf4 delta lake table structure
        cclf4_df = (
            ...
            .withColumn("clm_prod_type_cd", get_column(data_df, "clm_prod_type_cd"))
            .withColumn("clm_val_sqnc_num", to_int_udf(get_column(data_df, "clm_val_sqnc_num")))
            .withColumn("clm_dgns_cd", get_column(data_df, "clm_dgns_cd"))
            ...
            .withColumn("clm_poa_ind", get_column(data_df, "clm_poa_ind"))
        ...
        # write data into delta lake `cclf4` table
        cclf4_df.write.format("delta").mode("append").save(delta_table_location)
