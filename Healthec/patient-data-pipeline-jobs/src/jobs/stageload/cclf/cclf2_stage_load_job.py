...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "cclf2"),
        )
        ...
        # add additional columns and prepare dataframe which match with cclf2 delta lake table structure
        cclf2_df = (
            ...
            .withColumn("clm_line_prod_rev_ctr_cd", get_column(data_df, "clm_line_prod_rev_ctr_cd"))
            .withColumn("clm_line_instnl_rev_ctr_dt", get_column(data_df, "clm_line_instnl_rev_ctr_dt"))
            ...
            .withColumn("clm_rev_apc_hipps_cd", get_column(data_df, "clm_rev_apc_hipps_cd"))
            .withColumn("clm_fac_prvdr_oscar_num", get_column(data_df, "clm_fac_prvdr_oscar_num"))
        ...
        # write data into delta lake `cclf2` table
        cclf2_df.write.format("delta").mode("append").save(delta_table_location)
