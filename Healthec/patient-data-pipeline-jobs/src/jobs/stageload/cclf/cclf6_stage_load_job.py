...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "cclf6"),
        )
        ...
        # add additional columns and prepare dataframe which match with cclf6 delta lake table structure
        cclf6_df = (
            ...
            .withColumn("clm_line_cvrd_pd_amt", to_float_udf(get_column(data_df, "clm_line_cvrd_pd_amt")))
            .withColumn("clm_prmry_pyr_cd", get_column(data_df, "clm_prmry_pyr_cd"))
            .withColumn("payto_prvdr_npi_num", get_column(data_df, "payto_prvdr_npi_num"))
            .withColumn("ordrg_prvdr_npi_num", get_column(data_df, "ordrg_prvdr_npi_num"))
            ...
            .withColumn("clm_line_alowd_chrg_amt", to_float_udf(get_column(data_df, "clm_line_alowd_chrg_amt")))
        ...
        # write data into delta lake `cclf6` table
        cclf6_df.write.format("delta").mode("append").save(delta_table_location)
