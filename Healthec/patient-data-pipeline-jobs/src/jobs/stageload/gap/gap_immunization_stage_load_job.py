...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_immunization_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get(
            "DELTA_TABLE_NAME",
            config.get("delta_table_name", "gap_immunization"),
        )
        ...
        # add additional columns and prepare dataframe which match with gap immunization delta lake table structure
        immunization_df = (
            ...
            .withColumn("refused", get_column(canonical_df, "refused"))
            .withColumn("med_unnecessary_reason_code", get_column(canonical_df, "med_unnecessary_reason_code"))
            .withColumn("med_unnecessary_reason_name", get_column(canonical_df, "med_unnecessary_reason_name"))
            .withColumn(
                "med_unnecessary_reason_dictionary", get_column(canonical_df, "med_unnecessary_reason_dictionary")
            )
            ...
            .withColumn("administered_amount", get_column(canonical_df, "administered_amount"))
            .withColumn("administered_unit", get_column(canonical_df, "administered_unit"))
            .withColumn("vaccine_lot_number", get_column(canonical_df, "vaccine_lot_number"))
            .withColumn("immunization_manufacture_code", get_column(canonical_df, "immunization_manufacture_code"))
            ...
            .withColumn(
                "remove_specified_immunization_flag", get_column(canonical_df, "remove_specified_immunization_flag")
            )
            .withColumn("vfc_eligibility_dictionary", get_column(canonical_df, "vfc_eligibility_dictionary"))
            .withColumn("vfc_eligibility_code", get_column(canonical_df, "vfc_eligibility_code"))
        ...
        # write data into delta lake `gap_immunization` table
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_immunization", opsgenie_api_key, file_details)
