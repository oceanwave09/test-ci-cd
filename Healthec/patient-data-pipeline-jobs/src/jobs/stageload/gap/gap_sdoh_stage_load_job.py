...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_sdoh_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        sdoh_df = (
            ...
            .withColumn("patient_date_of_birth", get_column(canonical_df, "patient_date_of_birth"))
            ...
            .withColumn("source_name", get_column(canonical_df, "source_name"))
            .withColumn("screen_date", get_column(canonical_df, "screen_date"))
            .withColumn("screening_practice_name", get_column(canonical_df, "screening_practice_name"))
            .withColumn("question_group", get_column(canonical_df, "question_group"))
            .withColumn("question", get_column(canonical_df, "question"))
            .withColumn("answer", get_column(canonical_df, "answer"))
            .withColumn("mihin_common_key", get_column(canonical_df, "mihin_common_key"))
        ...
        # write data into delta lake `gap_sdoh` table
        sdoh_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_sdoh", opsgenie_api_key, file_details)
