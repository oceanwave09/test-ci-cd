...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_vital_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        # add additional columns and prepare dataframe which match with gap vital delta lake table structure
        vital_df = (
            ...
            .withColumn("vital_code", get_column(canonical_df, "vital_code"))
            .withColumn("vital_name", get_column(canonical_df, "vital_name"))
            .withColumn("vital_dictionary_name", get_column(canonical_df, "vital_dictionary_name"))
            ...
            .withColumn("remove_specified_vital_flag", get_column(canonical_df, "remove_specified_vital_flag"))
        ...
        # write data into delta lake `gap_vital` table
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_vital", opsgenie_api_key, file_details)
