...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_care_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        care_df = (
            ...
            .withColumn("visit_reason_code", get_column(canonical_df, "visit_reason_code"))
            .withColumn("visit_reason_name", get_column(canonical_df, "visit_reason_name"))
            .withColumn("visit_reason_dictionary", get_column(canonical_df, "visit_reason_dictionary"))
            ...
            .withColumn("remove_care_item", get_column(canonical_df, "remove_care_item"))
            .withColumn("value", get_column(canonical_df, "value"))
            .withColumn("modifier_dictionary_name", get_column(canonical_df, "modifier_dictionary_name"))
            .withColumn("modifier_code", get_column(canonical_df, "modifier_code"))
        ...
        # write data into delta lake `gap_care` table
        care_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_care", opsgenie_api_key, file_details)
