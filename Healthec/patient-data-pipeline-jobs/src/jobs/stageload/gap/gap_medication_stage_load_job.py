...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_medication_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        medication_df = (
            ...
            .withColumn("end_date", get_column(canonical_df, "end_date"))
            .withColumn("action_date", get_column(canonical_df, "action_date"))
            .withColumn("signed_date", get_column(canonical_df, "signed_date"))
            .withColumn("form", get_column(canonical_df, "form"))
            .withColumn("medication_type", get_column(canonical_df, "medication_type"))
            .withColumn("medi_contraindicated_flag", get_column(canonical_df, "medi_contraindicated_flag"))
            .withColumn("medi_class_contraindicated_flag", get_column(canonical_df, "medi_class_contraindicated_flag"))
            .withColumn("dose_value", get_column(canonical_df, "dose_value"))
            .withColumn("units", get_column(canonical_df, "units"))
            .withColumn("other", get_column(canonical_df, "other"))
            .withColumn("schedule", get_column(canonical_df, "schedule"))
            .withColumn("notes", get_column(canonical_df, "notes"))
            .withColumn("action", get_column(canonical_df, "action"))
            .withColumn("refills", get_column(canonical_df, "refills"))
            .withColumn("quantity", get_column(canonical_df, "quantity"))
            .withColumn("quantity_unit", get_column(canonical_df, "quantity_unit"))
            .withColumn("route_code_text", get_column(canonical_df, "route_code_text"))
            .withColumn("duration", get_column(canonical_df, "duration"))
            .withColumn("substitution_permitted", get_column(canonical_df, "substitution_permitted"))
            .withColumn("fill_number", get_column(canonical_df, "fill_number"))
            .withColumn("fill_date", get_column(canonical_df, "fill_date"))
            .withColumn("source_medication_id", get_column(canonical_df, "source_medication_id"))
            .withColumn("stop_reason", get_column(canonical_df, "stop_reason"))
            .withColumn("prescription_id", get_column(canonical_df, "prescription_id"))
            .withColumn("schedule_alternatives", get_column(canonical_df, "schedule_alternatives"))
            .withColumn("deleted", get_column(canonical_df, "deleted"))
            .withColumn("source_system", get_column(canonical_df, "source_system"))
        ...
        # write data into delta lake `gap_medication` table
        medication_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_medication", opsgenie_api_key, file_details)
