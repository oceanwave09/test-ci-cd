...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_medicalcondition_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        medicalcondition_df = (
            ...
            .withColumn("resolution_date", get_column(canonical_df, "resolution_date"))
        ...
        # write data into delta lake `gap_medicalcondition` table
        medicalcondition_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_medicalcondition", opsgenie_api_key, file_details)
