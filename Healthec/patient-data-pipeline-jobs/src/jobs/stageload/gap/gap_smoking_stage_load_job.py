...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_smoking_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        smoking_df = (
            ...
            .withColumn("smoking_status_code", get_column(canonical_df, "smoking_status_code"))
            .withColumn("smoking_status_name", get_column(canonical_df, "smoking_status_name"))
            .withColumn("smoking_dictionary_name", get_column(canonical_df, "smoking_dictionary_name"))
            .withColumn("start_date", get_column(canonical_df, "start_date"))
            .withColumn("end_date", get_column(canonical_df, "end_date"))
            .withColumn("last_confirmed_date", get_column(canonical_df, "last_confirmed_date"))
        ...
        # write data into delta lake `gap_smoking` table
        smoking_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_smoking", opsgenie_api_key, file_details)
