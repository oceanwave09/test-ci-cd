...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="gap_allergy_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        allergy_df = (
            ...
            .withColumn("allergy_start_date", get_column(canonical_df, "allergy_start_date"))
            .withColumn("allergy_end_date", get_column(canonical_df, "allergy_end_date"))
            .withColumn("allergy_reaction_code", get_column(canonical_df, "allergy_reaction_code"))
            .withColumn("allergy_reaction_name", get_column(canonical_df, "allergy_reaction_name"))
            .withColumn("allergy_reaction_dictionary", get_column(canonical_df, "allergy_reaction_dictionary"))
        ...
        # write data into delta lake `gap_allergy` table
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "gap_allergy", opsgenie_api_key, file_details)
