...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="radaid_brcatx_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get("DELTA_TABLE_NAME", config.get("delta_table_name", "radaid_brcatx"))
        ...
        # add additional columns and prepare dataframe which match with radaid breast tx delta lake table structure
        brcatx_df = (
            ...
            .withColumn("tnm", get_column(canonical_df, "tnm"))
        ...
        brcatx_df.write.format("delta").mode("append").save(delta_table_location)
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "radaid_brcatx", opsgenie_api_key, file_details)
