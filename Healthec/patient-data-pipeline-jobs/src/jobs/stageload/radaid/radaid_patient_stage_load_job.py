...
@click.option(
    ...
    "-a",
    help="spark app name",
    default="radaid_patient_stage_load_job",
)
@click.option(
    "--config-file-path",
    "-c",
...
def main(app_name, config_file_path=None):
    ...
    try:
        ...
        delta_table_name = os.environ.get("DELTA_TABLE_NAME", config.get("delta_table_name", "radaid_patient"))
        ...
        # add additional columns and prepare dataframe which match with radaid patient delta lake table structure
        patient_df = (
            ...
            .withColumn("year_of_birth", get_column(canonical_df, "year_of_birth"))
            ...
            .withColumn("years_in_us", get_column(canonical_df, "years_in_us"))
            .withColumn("total_income", get_column(canonical_df, "total_income"))
            .withColumn("insurance_type", get_column(canonical_df, "insurance_type"))
            .withColumn("high_deductible_insurance", get_column(canonical_df, "high_deductible_insurance"))
            .withColumn("marital_status", get_column(canonical_df, "marital_status"))
            .withColumn("family_size", get_column(canonical_df, "family_size"))
            .withColumn("family_brca_history", get_column(canonical_df, "family_brca_history"))
            .withColumn("history_brca", get_column(canonical_df, "history_brca"))
            .withColumn("brca", get_column(canonical_df, "brca"))
        ...
        try:
            ...
            validation_result_page = run_validation(canonical_df, "radaid_patient", opsgenie_api_key, file_details)
