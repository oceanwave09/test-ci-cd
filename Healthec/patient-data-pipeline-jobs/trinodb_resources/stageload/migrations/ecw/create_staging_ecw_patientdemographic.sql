CREATE TABLE IF NOT EXISTS cynchealth_staging.ecw_patientdemographic(
    row_id VARCHAR,
    apuid VARCHAR,
    record_id VARCHAR,
    patient_id VARCHAR,
    ...
    primary_insurance_start_date VARCHAR,
    primary_insurance_end_date VARCHAR,
    ...
    secondary_insurance_start_date VARCHAR,
    secondary_insurance_end_date VARCHAR,
    ...
    tertiary_insurance_start_date VARCHAR,
    tertiary_insurance_end_date VARCHAR,
...
WITH (
    LOCATION = 's3a://phm-development-datapipeline-bucket/delta-tables/cynchealth/staging/ecw_patientdemographic',
