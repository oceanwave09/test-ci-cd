CREATE TABLE IF NOT EXISTS cynchealth_staging.ecw_physicalexam (
    row_id VARCHAR,
    apuid VARCHAR,
    record_id VARCHAR,
    patient_id VARCHAR,
...
WITH (
    LOCATION = 's3a://phm-development-datapipeline-bucket/delta-tables/cynchealth/staging/ecw_physicalexam',
