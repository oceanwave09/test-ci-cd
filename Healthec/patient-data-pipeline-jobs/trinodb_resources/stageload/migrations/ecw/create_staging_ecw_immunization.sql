CREATE TABLE IF NOT EXISTS cynchealth_staging.ecw_immunization (
    row_id VARCHAR,
    apuid VARCHAR,
    record_id VARCHAR,
    item_id VARCHAR,
...
WITH (
    LOCATION = 's3a://phm-development-datapipeline-bucket/delta-tables/cynchealth/staging/ecw_immunization',
