CREATE TABLE IF NOT EXISTS cynchealth_staging.cclf2 (
    row_id VARCHAR,
    ...
    clm_fac_prvdr_oscar_num VARCHAR,
...
WITH (
    LOCATION = 's3a://phm-development-datapipeline-bucket/delta-tables/cynchealth/staging/cclf2',
