...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "patient", "stageload", "beneficiary_stage_load_job.yaml")
...
with DAG(
    dag_id="beneficiary_stage_load_dag",
    default_args=default_args,
    schedule_interval=None,
    max_active_runs=2,
    concurrency=2,
    description="Loads canonical beneficiary data into staging table in delta lake",
    template_searchpath=[TMPL_SEARCH_PATH],
    tags=["stageload", "beneficiary"],
) as dag:
