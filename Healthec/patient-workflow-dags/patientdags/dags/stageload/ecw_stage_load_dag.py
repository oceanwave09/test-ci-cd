...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "patient", "stageload", "ecw_stage_load_job.yaml")
...
with DAG(
    dag_id="ecw_stage_load_dag",
    default_args=default_args,
    schedule_interval=None,
    max_active_runs=2,
    concurrency=2,
    description="Loads canonical ecw data into staging table in delta lake",
