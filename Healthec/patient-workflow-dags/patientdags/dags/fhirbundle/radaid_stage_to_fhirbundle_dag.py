...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "patient", "fhirbundle", "radaid_stage_to_fhirbundle_job.yaml")
...
with DAG(
    dag_id="radaid_stage_to_fhirbundle_dag",
