...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "patient", "fhirbundle", "rx_claim_stage_to_fhirbundle_job.yaml")
...
with DAG(
    dag_id="rx_claim_stage_to_fhirbundle_dag",
