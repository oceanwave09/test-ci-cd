...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "patient", "fhirbundle", "ncqa_hedis_stage_to_fhirbundle_job.yaml")
...
with DAG(
    dag_id="ncqa_hedis_stage_to_fhirbundle_dag",
