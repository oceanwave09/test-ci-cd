...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TEMPLATE_SEARCH_PATH, "patient", "analyticalload", "measure_analytical_load_job.yaml")
...
with DAG(
    dag_id="measure_analytical_load_dag",
    default_args=default_args,
    schedule_interval=None,
    max_active_runs=1,
    concurrency=1,
    description="Loads measure data into analytical table in delta lake",
    template_searchpath=[TEMPLATE_SEARCH_PATH],
    tags=["analyticalload", "measure"],
) as dag:
