...
def _prepare_run_template(ti):
    ...
    if file_format.lower() != "cclf_beneficiary":
        raise ValueError("Invalid file format")

    src_template = os.path.join(TMPL_SEARCH_PATH, "patient", "fhirbundle",
                                "cclf_beneficiary_stage_to_fhirbundle_job.yaml")
...
with DAG(
    dag_id="cclf_beneficiary_stage_to_fhirbundle_dag",
    ...
    tags=["fhirbundle", "cclf_beneficiary"],
) as dag:
