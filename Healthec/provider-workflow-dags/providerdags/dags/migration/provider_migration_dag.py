...
from providerdags.utils.constants import LANDING_PATH_SUFIX, TMPL_SEARCH_PATH
from providerdags.utils.utils import (  # prepare_run_template,
...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "provider", "migration", "provider_migration_job.yaml")
...
with DAG(
    dag_id="provider_migration_dag",
    default_args=default_args,
    schedule_interval=None,
    catchup=False,
    description="Migrate provider entities with platform services",
