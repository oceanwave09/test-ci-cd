...
def _prepare_run_template(ti):
    ...
    src_template = os.path.join(TMPL_SEARCH_PATH, "provider", "stageload", "practice_stage_load_job.yaml")
...
with DAG(
    dag_id="practice_stage_load_dag",
    default_args=default_args,
    schedule_interval=None,
    max_active_runs=1,
    concurrency=1,
    description="Loads canonical practice data into staging table in delta lake",
    template_searchpath=[TMPL_SEARCH_PATH],
    tags=["stageload", "practice"],
) as dag:
