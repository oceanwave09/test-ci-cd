...
class Condition(Base):
    ...
    def __init__(
        ...
        resource_path = None
        if scope_id:
            resource_path = ResourceType.Condition.get_resource_path(scope, scope_id)
        super().__init__(
            client,
    ...
    def _resolve_scope(self, resource: dict) -> None:
        if resource.get("subject"):
            ...
            self._resource_path = ResourceType.Condition.get_resource_path(
                "Patient",
                self._scope_id
            )
