...
class MedicationAdministration(Base):
    """Medication Administration resource API client"""
    ...
    def __init__(
        ...
        resource_path = None
        if scope_id:
            resource_path = ResourceType.MedicationAdministration.get_resource_path(scope, scope_id)
        super().__init__(
            client,
            ResourceType.MedicationAdministration.value,
            scope=scope,
            scope_id=scope_id,
    ...
    def _resolve_scope(self, resource: dict) -> None:
        if resource.get("subject"):
            ...
            self._resource_path = ResourceType.MedicationAdministration.get_resource_path(
                "Patient",
                self._scope_id
            )
